...
<body>
    ...
    <div class="col-xs-12 container">
        <section id="resultado" style="margin-top:80px;">
            ...
            <c:if test="${!confirmaCadastro.isError()}">
                 <h:info-panel title="Cadastro confirmado com sucesso!" msg="Seu cadastro foi confirmado, clique <a class='btn btn-success' href='/profissional/admin'>aqui</a> para fazer login."/>
            </c:if>
