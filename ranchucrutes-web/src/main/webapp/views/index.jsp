        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    ...
                    <h3 class="section-subheading text-muted">Veja abaixo nossos serviços de agendamento</h3>
                </div>
            </div>
            <div class="row text-center">
                <div class="col-md-4">
                    ...
                    <h4 class="service-heading">Agendamento online</h4>
                    <p class="text-muted">Crie o seu cadastro e faça o agendamento online é muito simples.</p>
                </div>
                <div class="col-md-4">
                    <span class="fa-stack fa-4x">
                        <i class="fa fa-circle fa-stack-2x text-primary"></i>
                    ...
                    <h4 class="service-heading">Agendamento via smartphone</h4>
                    <p class="text-muted">Baixe o aplicativo crie um cadastro e saia usando</p>
                    <a href="https://play.google.com/store/apps/details?id=br.com.wjaa">
  <img alt="Get it on Google Play"
       src="https://developer.android.com/images/brand/pt-br_generic_rgb_wo_45.png" />
                ...
                <div class="col-md-4">
                    ...
                    <h4 class="service-heading">Agendamento por telefone</h4>
                    <p class="text-muted">Ligue para nossa central de atendimento e que nossos atendentes farão o agendamento para você (11) 99999-9999</p>
                </div>
                    ...
                    <div class="col-lg-12">
                        <div class="modal-body">
                            ...
                            <div class="row" style="margin-top:50px;">        
                                <button type="button" class="btn btn-warning" data-dismiss="modal"><i class="fa fa-times"></i> Voltar</button>
                            </div>    
