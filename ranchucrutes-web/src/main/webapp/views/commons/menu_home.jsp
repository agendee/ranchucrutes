...
<section class="navbar navbar-fixed-top custom-navbar" role="navigation" style="backgroud:black">
	<div class="container">
		<div class="navbar-header">
			...
			<a href="#" class="navbar-brand" style="margin-top:-10px"><img src="static/img/logo_mini_white.png" class="img-responsive" alt="about img"> </a>
		...
		<div class="collapse navbar-collapse">
			<ul class="nav navbar-nav navbar-right">
				...
				<li><a href="#portfolio" class="smoothScroll">PARCEIROS</a></li>
