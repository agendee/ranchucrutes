...
<head>
    ...
    <link href="/static/css/medico/login.css" rel="stylesheet">
</head>
<body>
                    ...
                    <div class="col-sm-6 col-md-3 col-md-offset-4">
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <form id="formLogin" role="form" action="/auth/medico" method="POST">
                                    <fieldset>
                                        <div class="row">
                            ...
                            <div class="panel-footer ">
                                Você não tem cadastro? <a href="/medico/cadastro" > Cadastre-se aqui </a>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <script src="/static/js/medico/login.js"></script>
</body>
</html>